...
result_path = '/gpfs/gpfs0/robert.jarolim/filament/unet_v1/evaluation'
...
files = sorted(glob.glob('/gpfs/gpfs0/robert.jarolim/data/filament/gong_img/*.jpg'))
...
shutil.make_archive('/gpfs/gpfs0/robert.jarolim/filament/unet_v1/gong_evaluation', 'zip', result_path)
